package com.female.workout.utils;
...
public class AbsWomenApplication extends Application {
    ...
    public  void a() {
        if (this.textToSpeech == null) {
            this.textToSpeech = new TextToSpeech(getInstance(), new com.female.workout.b.b(this));
        }
    }
    ...
    public void onCreate() {
        ...
        new Thread(new com.female.workout.b.a(this)).start();
    }
