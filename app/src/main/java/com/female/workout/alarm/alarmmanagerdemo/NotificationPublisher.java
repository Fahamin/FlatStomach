...
import com.female.workout.activities.Start_Activity;
import com.female.workout.alarm.alarm_pojo_classes.Reminder_custom;
...
public class NotificationPublisher extends BroadcastReceiver {
    ...
    private void startNotification(Context context2) {
        ...
        builder.setAutoCancel(true).setContentIntent(PendingIntent.getActivity(context2, getNextNotifId(), intent2, flag)).setDefaults(-1).setAutoCancel(true).setWhen(System.currentTimeMillis()).setSmallIcon(R.drawable.ic_stat_name).setContentTitle(str2).setContentText(str).setDefaults(1);
